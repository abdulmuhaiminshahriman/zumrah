...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'Utama', link: '/' },
      { text: 'Penulisan', link: '/markdown-examples', activeMatch: '/markdown-examples' },
      { 
        text: 'Daftar',
        items: [
